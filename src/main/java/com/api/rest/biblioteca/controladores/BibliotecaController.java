...
public class BibliotecaController {
	...
	@GetMapping("/getBiblio")
	public List<Biblioteca> listarBibliotecass(){
		List<Biblioteca> books = new ArrayList<Biblioteca>();
		bibliotecaRepository.findAll().forEach(books1 -> books.add(books1));
		return books;
	}
